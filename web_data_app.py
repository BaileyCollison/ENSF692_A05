...
def book_data():
    ...
    for book_price in prices:
        sale_prices.append(round(book_price * 0.75, 2))
...
def learn():
    ...
    what_i_learned = "In ENSF692, I learned how to create interactive interfaces and work wwith large data sets using Python!"

    return what_i_learned
